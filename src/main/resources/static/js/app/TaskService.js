    ...
    ['$localStorage', '$http', '$q', 'urls',
        function ($localStorage, $http, $q, urls) {
            ...
            function createTask(task) {
                ...
                var deferred = $q.defer();
                $http.post(urls.TASK_SERVICE, task)
                    .then(
                        function (response) {
                        	loadAllTasks();
                            deferred.resolve(response.data);
            ...
            function updateTask(task, id) {
                ...
                var deferred = $q.defer();
                $http.put(urls.TASK_SERVICE + id, task)
                    .then(
                        function (response) {
                        	loadAllTasks();
                            deferred.resolve(response.data);
            ...
            function removeTask(id) {
                ...
                var deferred = $q.defer();
                $http.delete(urls.TASK_SERVICE + id)
                    .then(
                        function (response) {
                        	loadAllTasks();
                            deferred.resolve(response.data);
